...
pub use envelope::{
    ...
    PROTOCOL_NAME, PROTOCOL_VERSION, Request, RequestKind, Response, ResponseBody, ResponseVersion,
    decode_request, decode_response, decode_response_for, encode_request, encode_response,
};
