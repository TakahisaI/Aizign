...
Test doubles and shared contract checks for Aizign crates. Not a published artifact.
...
| **Allowed dependencies** | `aizign-core`、`aizign-engine`、`serde_json`（fixtureの `.expect.json` 読み取り） |
| **Test command** | `cargo test -p aizign-testkit` |
