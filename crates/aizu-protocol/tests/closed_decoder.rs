...
fn hello(extra: &str) -> String {
    format!(
        r#"{{"protocol":"aizu","version":1,"requestId":"req-1","kind":"hello","payload":{{}}{extra}}}"#
    )
}
...
fn newer_versions_are_reported_with_recovered_ids_even_with_unknown_fields() {
    let frame = r#"{"protocol":"aizu","version":2,"requestId":"req-3","kind":"hello","payload":{},"futureField":true}"#;
    assert_eq!(
        code_of(frame),
        (
            Some("req-3".to_owned()),
    ...
    let frame =
        r#"{"protocol":"aizu","version":"1","requestId":"req-3","kind":"hello","payload":{}}"#;
...
fn missing_fields_are_rejected() {
    let frame = r#"{"protocol":"aizu","version":1,"kind":"hello","payload":{}}"#;
    assert_eq!(
        code_of(frame),
        (
            None,
    ...
    let frame = r#"{"protocol":"aizu","version":1,"requestId":"req-4","kind":"hello"}"#;
    assert_eq!(code_of(frame).2, codes::INVALID_ENVELOPE);
}
...
fn malformed_request_ids_are_rejected_and_not_echoed() {
    let frame =
        r#"{"protocol":"aizu","version":1,"requestId":"bad id","kind":"hello","payload":{}}"#;
    assert_eq!(
        code_of(frame),
        (
            None,
    ...
    let frame = format!(
        r#"{{"protocol":"aizu","version":1,"requestId":"{long}","kind":"hello","payload":{{}}}}"#
    );
...
fn unknown_kinds_are_rejected_with_recovered_ids() {
    let frame = r#"{"protocol":"aizu","version":1,"requestId":"req-5","kind":"workflow.other","payload":{}}"#;
    assert_eq!(
        code_of(frame),
        (
            Some("req-5".to_owned()),
...
fn hello_payload_must_be_an_empty_object() {
    let frame =
        r#"{"protocol":"aizu","version":1,"requestId":"req-6","kind":"hello","payload":{"x":1}}"#;
    assert_eq!(code_of(frame).2, codes::INVALID_PAYLOAD);
    let frame =
        r#"{"protocol":"aizu","version":1,"requestId":"req-6","kind":"hello","payload":[]}"#;
    assert_eq!(
        code_of(frame).2,
...
fn submit_payload_shape_errors_are_invalid_payload() {
    let frame = r#"{"protocol":"aizu","version":1,"requestId":"req-7","kind":"workflow.signal.submit","payload":{"expected":{}}}"#;
    assert_eq!(code_of(frame).2, codes::INVALID_PAYLOAD);
}

#[test]
fn responses_are_closed_too() {
    let frame = r#"{"protocol":"aizu","version":1,"requestId":"r","kind":"hello","ok":true,"payload":{"protocolVersion":1,"journalSchemaVersion":1,"capabilities":[],"package":{"name":"aizu","version":"0.1.0"}},"extra":1}"#;
    assert_eq!(
    ...
    let frame = r#"{"protocol":"aizu","version":1,"requestId":"r","kind":"hello","ok":true,"error":{"code":"X","message":""}}"#;
    assert_eq!(
        decode_response(frame.as_bytes())
            .unwrap_err()
            .code()
    ...
    let frame = r#"{"protocol":"aizu","version":1,"requestId":"r","kind":"hello","ok":false,"error":{"code":"INVALID_PAYLOAD","message":"m"}}"#;
...
fn encoded_frames_carry_the_protocol_version_and_escape_newlines() {
    let response = Response {
        request_id: None,
        kind: None,
        body: ResponseBody::Error(aizu_protocol::ProtocolError::new(
            codes::INTERNAL,
            "line one\nline two",
        )),
    };
