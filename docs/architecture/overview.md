...
| `adapters/dsh` | `@aizu/adapter-dsh`: DSH plugin（preflight、scope-bound `submit_workflow_signal`、one-shot client、evidence cold read）。fake DSH runtime + fake core / 実binaryの往復で検証 |
